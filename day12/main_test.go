...
var part1Samples = []string{"140", "772", "1930"}

const part1Answer = "1400386"

var part2Samples = []string{"80", "436", "1206", "236", "368"}

const part2Answer = "851994"
...
func Test_Part1_Sample3(t *testing.T) {
	Helper(t, part1, "sample3.txt", part1Samples[2])
}
...
func Test_Part2_Sample2(t *testing.T) {
	Helper(t, part2, "sample2.txt", part2Samples[1])
}

func Test_Part2_Sample3(t *testing.T) {
	Helper(t, part2, "sample3.txt", part2Samples[2])
}

func Test_Part2_Sample4(t *testing.T) {
	Helper(t, part2, "sample4.txt", part2Samples[3])
}

func Test_Part2_Sample5(t *testing.T) {
	Helper(t, part2, "sample5.txt", part2Samples[4])
}
